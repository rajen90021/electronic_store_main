...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo(
                ...
                "This is backend project created by Rajen gupta",
                "1.0.0V",
                "https://www.rajen@.com",
                new Contact("Rajen gupta", "https://www.instagram.com/@rajen90021", "grajengupta@gmail.com"),
                "License of APIS",
                "https://www.rajen@.com/about",
                new ArrayDeque<>()
        );
